...
exports.PasskeyAuthModule = void 0;
const common_1 = require("@nestjs/common");
const passkey_auth_controller_1 = require("./passkey-auth.controller");
...
let PasskeyAuthModule = class PasskeyAuthModule {
};
PasskeyAuthModule = __decorate([
    (0, common_1.Module)({
        imports: [
        ...
        providers: [passkey_auth_service_1.PasskeyAuthService, auth_service_1.AuthService],
        controllers: [passkey_auth_controller_1.PasskeyAuthController],
        exports: [passkey_auth_service_1.PasskeyAuthService],
    })
], PasskeyAuthModule);
exports.PasskeyAuthModule = PasskeyAuthModule;
//# sourceMappingURL=passkey-auth.module.js.map