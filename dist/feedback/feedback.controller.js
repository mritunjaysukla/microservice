...
const updateFeedback_dto_1 = require("./dto/updateFeedback.dto");
let FeedbackController = class FeedbackController {
    ...
    async toggleSelectFeedback(id, select) {
        return this.feedbackService.toggleSelectFeedback(id, select);
    }
};
__decorate([
    (0, common_1.Post)(),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, updateFeedback_dto_1.UpdateFeedbackDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    (0, common_1.Patch)(':id/select'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Query)('select', common_1.ParseBoolPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Boolean]),
    __metadata("design:returntype", Promise)
], FeedbackController.prototype, "toggleSelectFeedback", null);
